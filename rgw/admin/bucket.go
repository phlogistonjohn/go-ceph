...
func (api *API) ListBuckets(ctx context.Context) ([]string, error) {
	body, err := api.callAPI(ctx, get, "/bucket", nil)
	if err != nil {
		return nil, err
	}
	var s []string
...
func (api *API) GetBucketInfo(ctx context.Context, bucket string) (*Bucket, error) {
	b := Bucket{
		Bucket: bucket,
	}
	body, err := api.callAPI(ctx, get, "/bucket", valueToURLParams(b))
	if err != nil {
		return nil, err
	}
...
func (api *API) GetBucketPolicy(ctx context.Context, bucket string) (*Policy, error) {
	b := Bucket{
		Bucket: bucket,
		Policy: true,
	}
...
func (api *API) RemoveBucket(ctx context.Context, bucket string) error {
	b := Bucket{
		Bucket: bucket,
	}
	_, err := api.callAPI(ctx, delete, "/bucket", valueToURLParams(b))
	if err != nil {
		return err
	}
