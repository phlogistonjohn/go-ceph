...
// callAPI makes request to the RGW Admin Ops API
func (api *API) callAPI(ctx context.Context, verb verbHTTP, path string, args url.Values) (body []byte, err error) {
...
func (api *API) doRequest(request *http.Request) (*http.Response, error) {
